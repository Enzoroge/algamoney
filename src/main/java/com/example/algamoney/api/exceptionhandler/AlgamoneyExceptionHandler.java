...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	//resposta simples apos pedir pra deletar um codigo ja deletado
	//@ExceptionHandler({EmptyResultDataAccessException.class})
	//@ResponseStatus(HttpStatus.NOT_FOUND) 
	//public void handlerEmptyResultDataAccessException() {
	
	//resposta incremantada para desenvolvedor e cliente
	@ExceptionHandler({EmptyResultDataAccessException.class})
	...
	public ResponseEntity<Object>handlerDataIntegrityViolatioException( DataIntegrityViolationException ex, WebRequest request) {
	String mensagemUsuario = messageSource.getMessage("recurso.nao-encontrado", null, LocaleContextHolder.getLocale());
	...
	//BindingResult contem lista de erros
